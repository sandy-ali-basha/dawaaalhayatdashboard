...
import { useDeleteCurrencies } from "hooks/currencies/useDeleteCurrencies";
    ...
    <React.Fragment>
      ...
      >
        ...
        <DialogActions>
          ...
          {loading && <Loader />}
          <Button autoFocus sx={{}} variant="contained" onClick={DeleteCurrencies}>
            {t("Agree")}
          </Button>
        </DialogActions>
      </Dialog>
