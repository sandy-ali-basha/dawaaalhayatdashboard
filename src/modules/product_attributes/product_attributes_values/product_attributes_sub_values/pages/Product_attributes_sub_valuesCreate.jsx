...
import { useProduct_attributes_sub_valuesCreate } from "../hooks/useProduct_attributes_sub_valuesCreate";
const Product_attributes_sub_valuesCreate = () => {
  const {
    handleCancel,
    hanldeCreate,
    register,
    ...
    errors,
    details,
  } = useProduct_attributes_sub_valuesCreate();

  return (
    <Box>
      {loading && <Loader />}
      <Typography sx={{ color: "text.main", mb: "16px" }} variant="h5">
        {t("Create Product sub values")}
      </Typography>
...
export default Product_attributes_sub_valuesCreate;
